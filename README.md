...
### ✦ Add Deposit / Payment
Hands-on data entry with automatic date/time stamping (formatted to eliminate nanoseconds!) and a confirmation loop to ensure accuracy before saving to the file.
...
- **Payments:** Filtered for negative values.
...
#### Contact  email: _MeleyMM88@gmail.com_
